...
class OrderController extends Controller
{
    ...
    public function transferPaymentMode($orderId)
    {
        ...
        //send email
        $this->prepareConfirmationEmails($user, $order, $products, $grandTotal, $paidWithPayPal, $balanceToPay);

        return view('order.success', compact('order', 'orderId', 'products', 'grandTotal', 'paidWi$paidWithPayPal', 'balanceToPay'));
    }

    public function prepareConfirmationEmails($user, $order, $products, $grandTotal, $paidWithPayPal, $balanceToPay)
    {
        // to user
