    ...
    <body>
        <div class="container mt-2">
            ...
            <h5 class="mt-3"><b>Total a pagar
                    {{ $order->payment_mode === 'transfer' ? '' : 'contra entrega' }}
            ...
            @if ($order->payment_mode === 'transfer')
                ...
                <p class="mt-2 mb-5"><em>Si no se confirma tu pago para tu fecha de entrega deseada, ésta será
                        reprogramada.</em> No te preocupes, nos pondremos en contacto contigo.</p>
            @endif
